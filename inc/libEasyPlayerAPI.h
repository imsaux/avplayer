...
typedef int (CALLBACK *MediaSourceCallBack)( int _channelId, void *_channelPtr, int _frameType, char *pBuf, RTSP_FRAME_INFO* _frameInfo);
typedef int (CALLBACK *FrameCallBack)( int _channelId, void *_channelPtr, int _frameType, char *pBuf, int bufSize, int width, int height);
...
LIB_EASYPLAYER_API int EasyPlayer_OpenStream(const char *url, HWND hWnd, RENDER_FORMAT renderFormat, int rtpovertcp, const char *username, const char *password, MediaSourceCallBack callback=NULL, FrameCallBack frameCallback =NULL, void *userPtr=NULL);
...
LIB_EASYPLAYER_API int EasyPlayer_StartManuRecording(int channelId, char *szPath);
...
//add by:lifei
LIB_EASYPLAYER_API int EasyPlayer_AddPoint(int channelId, int x, int y);
LIB_EASYPLAYER_API int EasyPlayer_ClearPoint(int channelId);
LIB_EASYPLAYER_API int EasyPlayer_GetFrameSize(int channelId, int *nWidth, int *nHeight);

LIB_EASYPLAYER_API int EasyPlayer_AddRect(int channelId, RECT rt);
LIB_EASYPLAYER_API int EasyPlayer_ClearRect(int channelId);
